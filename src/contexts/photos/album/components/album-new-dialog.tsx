   ...
   <DialogContent>
    ...
    <DialogBody className="flex flex-col gap-5">
     ...
     <div className="space-y-3">
      <Text as="div" variant="label-small" className="space-y-3">Foto cadastradas</Text>
      ...
      {!isLoadingPhotos && photos.length === 0 && (
       <div className="w-full flex flex-col justify-center gap-3 items-center">
        ...
        <Text variant="paragraph-medium" className="text-center">Nenhuma foto disponivel para seleção</Text>
       </div>
      )}
     </div>
    </DialogBody>
